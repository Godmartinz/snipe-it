<span>
    <div class="form-group{{ $errors->has('custom_fieldset') ? ' has-error' : '' }}">
        ...
        <div class="col-md-5">
            {{ Form::select('fieldset_id', Helper::customFieldsetList(), old('fieldset_id', $fieldset_id),
                array(
                    'class'=>'select2 js-fieldset-field livewire-select2',
        ...
        <div class="col-md-3">
            @if ($fieldset_id)
                <label class="form-control">
                    ...
                    {{ Form::checkbox('add_default_values', 1, old('add_default_values', $add_default_values),
                        [
                            'data-livewire-component' => $this->getId(),
