                        ...
                        >
                            <thead>
                                <tr>
                                    ...
                                    <th data-field="purchase_date" data-sortable="true">{{ trans('general.purchase_date') }}</th>
                                    <th data-field="expiration" data-sortable="true">{{ trans('admin/licenses/form.expiration') }}</th>
                                    <th data-field="expires_in" data-sortable="true">{{ trans('mail.expires') }}</th>
                                    <th data-field="termination_date" data-sortable="true">{{ trans('admin/licenses/form.termination_date') }}</th>
                                    <th data-field="terminates_in" data-sortable="true">{{ trans('mail.terminates') }}</th>
                                </tr>
                            </thead>
                            <tbody>
