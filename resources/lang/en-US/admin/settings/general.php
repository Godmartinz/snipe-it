...
'ldap_location_help'             => 'The Ldap Location field should be used if <strong>an OU is not being used in the Base Bind DN.</strong> Leave this blank if an OU search is being used.',
    ...
    'ldap_ou_sync_type'         => 'LDAP OU Sync Type',
    'ldap_ou_sync_type_help'    => 'Be sure you are using the correct IP address in <strong>LDAP server</strong> if syncing by Company.',
    'ldap_ou_sync_tool_tip'     => 'Currently the :option LDAP OUs are being used on the LDAP User Sync page. ',
